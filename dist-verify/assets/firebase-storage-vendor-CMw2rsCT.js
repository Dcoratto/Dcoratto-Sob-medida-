import{_ as me,r as X,S as Re,a as be,b as we,g as Te}from"./firebase-core-vendor-C8EVUDP1.js";import{C as ye,F as ke,j as P,y as Ee,o as Q,r as Ae,z as Ue}from"./firebase-vendor-Dp54MSk0.js";/**
 * @license
 ...
 */const ee="firebasestorage.googleapis.com",te="storageBucket",Oe=120*1e3,Ie=600*1e3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ve(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let c=!1;function d(...p){c||(c=!0,t.apply(null,p))}function R(p){r=setTimeout(()=>{r=null,e(b,u())},p)}function m(){o&&clearTimeout(o)}function b(p,...I){if(c){m();return}if(p){m(),d.call(null,p,...I);return}if(u()||i){m(),d.call(null,p,...I);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,R(T)}let w=!1;function k(p){w||(w=!0,m(),!c&&(r!==null?(p||(a=2),clearTimeout(r),R(0)):p||(a=1)))}return R(0),o=setTimeout(()=>{i=!0,k(!0)},n),k}function ze(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _e="storage";function Ht(e,t,n){return e=P(e),Ot(e,t,n)}function $t(e){return e=P(e),It(e)}function jt(e){return e=P(e),Nt(e)}function qt(e,t){return e=P(e),xt(e,t)}function Vt(e=Te(),t){e=P(e);const s=we(e,_e).getImmediate({identifier:t}),r=Ee("storage");return r&&St(s,...r),s}function St(e,t,n,s={}){Lt(e,t,n,s)}function vt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new W(n,s,r,t,Re)}function Bt(){me(new ye(_e,vt,"PUBLIC").setMultipleInstances(!0)),X(Z,J,""),X(Z,J,"esm2020")}Bt();export{$t as a,jt as d,Vt as g,qt as r,Ht as u};
