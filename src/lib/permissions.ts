...
const fullPermissions: PermissionMap = {
  ...
  funcionarios: {visualizar: true, cadastrar: true, editar: true, jornada: true, apontar: true},
  veiculos: {visualizar: true, cadastrar: true, editar: true, usar: true},
...
const noPermissions: PermissionMap = {
  ...
  funcionarios: {visualizar: false, cadastrar: false, editar: false, jornada: false, apontar: false},
  veiculos: {visualizar: false, cadastrar: false, editar: false, usar: false},
