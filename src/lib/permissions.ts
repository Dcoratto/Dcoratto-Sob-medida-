...
const fullPermissions: PermissionMap = {
  ...
  almoxarifado: {visualizar: true, editar: true, movimentar: true, comprar: true},
  funcionarios: {visualizar: true, cadastrar: true, editar: true, jornada: true, apontar: true, verRelatorios: true},
  veiculos: {visualizar: true, cadastrar: true, editar: true, usar: true, verRelatorios: true},
...
const noPermissions: PermissionMap = {
  ...
  almoxarifado: {visualizar: false, editar: false, movimentar: false, comprar: false},
  funcionarios: {visualizar: false, cadastrar: false, editar: false, jornada: false, apontar: false, verRelatorios: false},
  veiculos: {visualizar: false, cadastrar: false, editar: false, usar: false, verRelatorios: false},
  ...
  cliente: {visualizar: false, editarDados: false, alterarEtapa: false, anexarArquivos: false, avaliarFuncionarios: false, verValores: false},
...
export const DEFAULT_ROLE_PERMISSIONS: Record<AccessRole, PermissionMap> = {
  vendedor: withPermissions({
    ...
    almoxarifado: {visualizar: true, movimentar: true},
    veiculos: {visualizar: true, usar: true},
    cliente: {visualizar: true, editarDados: true, alterarEtapa: true, anexarArquivos: true, verValores: true},
    medicao: {visualizar: true, criar: true, editar: true},
  ...
  liberacao: withPermissions({
    dashboard: {visualizar: true},
    funcionarios: {visualizar: true, apontar: true},
    veiculos: {visualizar: true, usar: true},
    cliente: {visualizar: true, verValores: false},
    historico: {visualizar: true},
    almoxarifado: {visualizar: true},
  ...
  administrativo: withPermissions({
    ...
    cliente: {visualizar: true, editarDados: true, anexarArquivos: true, verValores: true},
