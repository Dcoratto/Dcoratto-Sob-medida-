...
const ensurePieceWorkflowStatus = (piece: QuotePiece, fallbackStatus?: QuoteStatus): QuotePiece => ({
  ...piece,
  pieceStatus: normalizeQuoteStatus(piece.pieceStatus || fallbackStatus || 'OrÃ§amento'),
});
...
export const QuoteEditor: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-32">
      ...
      {quoteDraftRecovered && (
        <DraftNotice
          message="Este orÃ§amento voltou com o rascunho salvo automaticamente. VocÃª pode seguir de onde parou."
              ...
              <div key={piece.id} className="bg-white rounded-[32px] border border-slate-100 shadow-sm overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300">
                ...
                <div className="absolute bottom-2 right-2 bg-green-500 w-3 h-3 rounded-full border-2 border-white shadow-sm" title="Desenho tÃ©cnico disponÃ­vel" />
                    ...
                    <div className="md:col-span-3 grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Status da peÃ§a</label>
                        <select
